...
function swiperSlide1() {
	var swiper = new Swiper('.rater_slider .swiper-container', {
		slidesPerView: 4,
		spaceBetween: 10,
		loop: false, 
		navigation: {
			nextEl: '.rater_slider .swiper-button-next',
			prevEl: '.rater_slider .swiper-button-prev',
		},
		scrollbar: {
			el: ".rater_slider .swiper-scrollbar",
			draggable: true,
		},
		breakpoints: { 
			1279: {
	...
	$(".rater_info").on("click", function(){
		$(".rater_info").removeClass('on');
		$(this).addClass("on");
	});
}
